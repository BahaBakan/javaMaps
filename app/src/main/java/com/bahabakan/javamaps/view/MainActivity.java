...
import com.bahabakan.javamaps.adapter.PlaceAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuInflater menuInflater = getMenuInflater(); // Menüleri Bağlamak için kullanıyoruz.
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
       ...
       if(item.getItemId()==R.id.add_place){
           ...
           intent.putExtra("info","new"); //yeni bir mekan eklemeye çalışıldığını belirtiyoruz.
